...
adh_corr = corr_matrix["Formula-SGR"].sort_values(ascending=False)
...
print("=== 与 Eadh formula(Rank) 的 Spearman 相关系数（从大到小） ===")
print(adh_corr)
# 保存为 PDF
png_file = "Spearman_Correlation_with_Formula_Ranking.png"
output_file = "Spearman_Correlation_with_Formula_Ranking.pdf"
