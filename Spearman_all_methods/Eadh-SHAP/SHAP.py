...
# 1. 读取Excel数据
file_path = "Eadh formula(SHAP).xlsx"
...
adh_corr = corr_matrix["Formula-SHAP"].sort_values(ascending=False)
...
print("=== 与 Eadh formula(SHAP) 的 Spearman 相关系数（从大到小） ===")
print(adh_corr)
# 保存为 PDF
png_file = "Spearman_Correlation_with_Formula_SHAP.png"
output_file = "Spearman_Correlation_with_Formula_SHAP.pdf"
...
with pd.ExcelWriter(output_excel, engine='openpyxl') as writer:
    ...
    adh_corr.to_excel(writer, sheet_name="Formula(SHAP) Ranking")
