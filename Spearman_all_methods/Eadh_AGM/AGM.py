...
adh_corr = corr_matrix["Formula-AGM"].sort_values(ascending=False)
...
print("=== 与 Eadh formula(Average of all data) 的 Spearman 相关系数（从大到小） ===")
print(adh_corr)
# 保存为 PDF
png_file = "Spearman_Correlation_with_Formula_all.png"
output_file = "Spearman_AGM.pdf"
...
with pd.ExcelWriter(output_excel, engine='openpyxl') as writer:
    ...
    adh_corr.to_excel(writer, sheet_name="Formula(all) Ranking")
