...
# ---------- 配置区 ----------
png_paths = [
    "RF_KernelSHAP_custom_order.png",
    "GBRT_KernelSHAP_custom_order.png",
    "XGBoost_KernelSHAP_custom_order.png",
    "LR_KernelSHAP_custom_order.png",
    "MLP_KernelSHAP_custom_order.png",
    "SVR_KernelSHAP_custom_order.png"
]

# png_paths = [
#     "RF_KernelSHAP2.png",
#     "GBRT_KernelSHAP2.png",
#     "XGBoost_KernelSHAP2.png",
#     "LinearRegression2.png",
#     "MLP2.png",
#     "SVR_SHAP_Summary.png"
# ]
out_pdf = "KernelSHAP.pdf"
# out_pdf= "KernelSHAP_Summary.pdf"
labels = ["A","B","C","D","E","F"]  # 字母标签
# ----------------------------
for p in png_paths:
