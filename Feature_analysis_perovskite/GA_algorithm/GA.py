...
if __name__ == "__main__":
    ...
    draw_heatmap(np.fliplr(target_matrix), best_order_names, save_name="GA_Target_perov")
    draw_heatmap(best_corr_verify, best_order_names, save_name="GA_Spearman_perov")