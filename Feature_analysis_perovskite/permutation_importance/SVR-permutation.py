...
best_params = {
    'kernel': 'rbf',
    'C': 994.5831179044228,
    'epsilon': 0.02232386821844736,
    'gamma': 0.0022362708493146688
}
# best_params = {
#     'kernel': 'rbf',
...
plt.savefig("SVR_PFI_custom_order.png", dpi=300, bbox_inches="tight")
plt.close()
...
ga_df.to_excel("GA_ranking_SVR_PFI.xlsx", index=False)
